...
public class ShuffleboardHelpers {
    ...
    /**
     * Create a new tab with horizontal grids sized 2x4. Lets you consume the response using GenericEntry
     * <pre>
     ...
     * </pre>
     */
    public static LinkedHashMap<String, GenericEntry> Create_TabWithGrids_Editable(String tabName, String gridName, LinkedHashMap<String, Double> values)
    {
        return Create_TabWithGrids_Editable(tabName, gridName, 2, 4, values);
    }
    
    /**
     * Create a new tab with horizontal grids of custom size. Lets you consume the response using GenericEntry
     * <pre>
     *  var valueMap = new LinkedHashMap<String, Double>();
     *  valueMap.put("Value 1 Name", value1Variable);
     *  newValue1Variable = widgets.get("Value 1 Name").getDouble(defaultValue1);
     * </pre>
     */
    public static LinkedHashMap<String, GenericEntry> Create_TabWithGrids_Editable(String tabName, String gridName, int gridWidth, int gridHeight, LinkedHashMap<String, Double> values)
    {
