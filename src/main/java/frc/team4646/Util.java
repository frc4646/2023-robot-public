...
public class Util {
    ...
    /**
     * Correct for a joystick's deadband and also apply a x^power factor. If *value* is below *deadband*, treat as 0
     * @param value input, -1-1
     * @param deadband ignore below this, scale from 0-1 above this
     * @param power value^power scaling
     * @return
     */
